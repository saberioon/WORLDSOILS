...
#program_input="some options for the python script"
  ...
  echo "python /home/saberioo/WORLDSOILS/src/LUCAS15_analysis.py -i $dir_in -o $dir_out" >> /home/saberioo/WORLDSOILS/run_jobs/run_"$i".tmp
  # show what will be done
  echo "python /home/saberioo/WORLDSOILS/src/LUCAS15_analysis.py -i $dir_in -o $dir_out"
