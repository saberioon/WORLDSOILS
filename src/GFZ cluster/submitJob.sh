...
dir_in="/home/saberioo/WORLDSOILS/data/S2a_lucas15_merged.csv"
...
#program_input="some options for the python script"
  ...
  echo "python /home/saberioo/WORLDSOILS/src/LUCAS15_analysis.py $dir_in $dir_out" >> /home/saberioo/WORLDSOILS/run_jobs/run_"$i".tmp
  # show what will be done
  echo "python /home/saberioo/WORLDSOILS/src/LUCAS15_analysis.py $dir_in $dir_out"
