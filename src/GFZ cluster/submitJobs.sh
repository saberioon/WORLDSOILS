...
for i in `seq 1 1 5` # lines in the cluster_input.txt file that shall be used as input
  ...
  # create run script for each job in list
    ...
    echo "python /home/saberioo/WORLDSOILS/src/fnn.py -i $data_path/$program_input -o $dir_out" -b 8 -e 300 -l 4 -r 0.001   >> /home/saberioo/WORLDSOILS/run_jobs/run_"$i".tmp

    # show what will be done
    echo "python /home/saberioo/WORLDSOILS/src/fnn.py -i $data_path/$program_input -o $dir_out" -b 8 -e 300 -l 4 -r 0.001
